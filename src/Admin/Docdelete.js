...
sendData(ev){
 ...
 const data={
  ...
  Axios.get('http://localhost:8080/examples/docdelete.jsp',{params:data}).then(response=>{
...
<TextField variant="outlined" margin="normal" required fullWidth id="Doctor name" label="Doctor name" name="t1" autoComplete="Hospital" autoFocus onChange={this.fun.bind(this)}/> 
