 ...
 class Vent extends Component
  {
    ...
    <div className={classes.form} noValidate>
        ...
        <TextField variant="outlined" margin="normal" required fullWidth id=" venti" label="No. of ventilators" name="venti" autoComplete="venti" autoFocus onChange={this.handleChangeFields}/> 
...
export default withStyles(useStyles)(Vent);